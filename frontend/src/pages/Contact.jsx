...
//             setFormData({
//                 name: '', email: '', phone: '',
//                 serviceOfInterest: 'General Inquiry', message: ''
//             });
//         }
//         // Reset the contact slice state after showing the message
//         dispatch(reset());
//     }
...
//               Have questions about our services or need help with your application? Our team is ready to assist you.
//             </p>
//           </motion.div>
...
//             {/* Contact Form */}
//             <motion.div 
//                 initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}
...
//                   <input type="text" name="name" value={name} onChange={onChange} placeholder="Your Name" className="w-full p-3 border border-gray-300 rounded-lg" required />
//                   <input type="email" name="email" value={email} onChange={onChange} placeholder="Your Email" className="w-full p-3 border border-gray-300 rounded-lg" required />
//                 </div>
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
//                     <input type="tel" name="phone" value={phone} onChange={onChange} placeholder="Phone Number (Optional)" className="w-full p-3 border border-gray-300 rounded-lg" />
//                     <select name="serviceOfInterest" value={serviceOfInterest} onChange={onChange} className="w-full p-3 border border-gray-300 rounded-lg bg-white">
...
//                 </div>
//                 <div className="mb-6">
//                   <textarea name="message" value={formMessage} onChange={onChange} placeholder="Your Message" rows="6" className="w-full p-3 border border-gray-300 rounded-lg" required></textarea>
//                 </div>
//                 <button type="submit" className="bg-primary text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors w-full md:w-auto" disabled={isLoading}>
...
//                     <FaMapMarkerAlt className="text-primary mt-1 mr-4 flex-shrink-0" size={20} />
//                     <span>123 Finance Street, Suite 100<br/>Metropolis, MP 54321</span>
//                   </li>
//                   <li className="flex items-center">
//                     <FaPhoneAlt className="text-primary mr-4" size={20} />
//                     <a href="tel:+1234567890" className="hover:text-primary">(123) 456-7890</a>
//                   </li>
//                   <li className="flex items-center">
//                     <FaEnvelope className="text-primary mr-4" size={20} />
//                     <a href="mailto:contact@Verity Finance.com" className="hover:text-primary">contact@Verity Finance.com</a>
//                   </li>
//                 </ul>
//               </div>
//             </motion.div>
